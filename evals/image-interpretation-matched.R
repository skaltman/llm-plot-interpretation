# Image interpretation matched eval
...
# sonnet <-
#   run_eval(
#     samples_dir = "samples/image-interpretation-matched",
...
# )
#
# sonnet |> write_rds("results/image-interpretation-matched/sonnet.rds")
#
...
# )
#
# gpt_5 |> write_rds("results/image-interpretation-matched/gpt_5.rds")
#
...
# )
#
# gemini |> write_rds("results/image-interpretation-matched/gemini.rds")
#
...
sonnet <-
  run_eval(
    ...
    scorer_instructions = custom_instructions,
    name = "image_interpretation_matched_prompt_memo",
    epochs = 3
)

sonnet |> write_rds("results/image-interpretation-matched-prompt-memo/sonnet.rds")
...
gpt_5 |> write_rds("results/image-interpretation-matched-prompt-memo/gpt_5.rds")
...
gemini |> write_rds("results/image-interpretation-matched-prompt-memo/gemini.rds")

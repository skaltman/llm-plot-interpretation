...
# sonnet |> write_rds("results/plot-baseline/sonnet.rds")
...
# gpt_5 |> write_rds("results/plot-baseline/gpt_5.rds")
...
# gemini |> write_rds("results/plot-baseline/gemini.rds")
...
sonnet_skepticism <-
  run_eval(
    ...
    scorer_instructions = custom_instructions,
    name = "plot_baseline_prompt_memo",
    epochs = 3
)

sonnet_skepticism |> write_rds("results/plot-baseline-prompt-memo/sonnet.rds")
...
gpt_5_skepticism |> write_rds("results/plot-baseline-prompt-memo/gpt_5.rds")
...
gemini_skepticism |> write_rds("results/plot-baseline-prompt-memo/gemini.rds")
